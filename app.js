...
function array(arrayName) {
    arrayName.map(index => {
        ...
        divInfo.appendChild(divText)
                ...
                // CATEGORIES ARRAY PROPERTIES (REDUCE USED)
let grup = 'category'
sorting = menu.reduce((acc, menuElemanı) => {
    ...
    {}
                ...
                // BUTTONS CLİCK FUNCTION PROPERTIES
